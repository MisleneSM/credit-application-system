...
class CustomerServiceTest {
    ...
    fun `should create customer`(){
        ...
        //then - parte assertiva, se de fato estamos tendo o retorno esperado
        Assertions.assertThat(actual).isNotNull
        Assertions.assertThat(actual).isSameAs(fakeCustomer) // isSameAs verifica se é igual
    ...
    @Test
    fun `should not find customer by invalid and throw BunessException`(){
        // given
        val fakeId: Long = Random().nextLong()
